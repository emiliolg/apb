...
public final class JavaSystemCaller
{
    ...
    public abstract static class ExecEnvironmentFactory
    {
        ...
        protected final String buildCommandLine(final String            aCommand,
                                                final ArrayList<String> someParameters)
        {
    ...
    public static final class Exec
    {
        ...
        private static ExecEnvironmentFactory getExecEnvironmentFactory(final String    aCommand,
                                                                        final String... someParameters)
        {
        ...
        extends ExecEnvironmentFactory
    {
         ...
         */
        @Override public IShell createShell()
        {
         ...
         */
        @Override public String createCommandLine()
        {
            String aCommand = getCommand();

            if ("dir".equals(aCommand.toLowerCase().trim())) {
                aCommand = "ls";
            }
        ...
        implements IShell
    {
         ...
         */
        @Override public final String getShellCommand()
        {
            return "/bin/sh -c";
        }
    }
        ...
        extends ExecEnvironmentFactory
    {
        ...
        @Override public String createCommandLine()
        {
            ...
            if ("ls".equals(aCommand.toLowerCase().trim())) {
                aCommand = "dir";
            }
