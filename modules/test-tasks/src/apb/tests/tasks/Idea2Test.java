...
import static apb.idegen.Idegen2Task.generateModule;
import static apb.idegen.Idegen2Task.generateProject;

public class Idea2Test
    extends TaskTestCase
{
    ...
    private static final String SIMPLE = "simple2";
    private static final String IML = ".iml";
    private static final String IPR = ".ipr";
    private static final String MOD1 = "template2.module1";
    private static final String MOD2 = "template2.module2";
    private static final String PROJ1 = "template2.project";
