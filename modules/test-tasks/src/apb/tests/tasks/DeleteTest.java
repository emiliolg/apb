    ...
    extends TestCase
{
    ...
    private void createFile(File dir, String file, String[] data)
        throws IOException
    {
    ...
    private void assertDoesNotExist(File file)
    {
        assertFalse("File: '" + file.getAbsolutePath() + " still exists.", file.exists());
    }
