...
public abstract class Idegen2Task
{
    //~ Instance fields ......................................................................................
     ...
     */
    public Idegen2Task(String id, File modulesHome)
    {
        env = Apb.getEnv();
        this.id = id;
     ...
     */
    public Idegen2Task ifOlder(long timeStamp)
    {
     ...
     */
    public Idegen2Task usingTemplate(@NotNull String templateFile)
    {
    ...
    */
    public static class ModuleBuilder
    {
        ...
        {
            return new Idea2Task.Module(id, dir);
        }
    }
    ...
    */
    public static class ProjectBuilder
    {
        ...
        {
            return new Idea2Task.Project(projectId, dir, projectDirectory);
        }
    }
}