    ...
    extends IdegenCommand
{
    ...
    private static Idegen2Task.Module createTask(ModuleHelper mod, final IdeaInfo info, final File dir)
    {
        ...
        return Idegen2Task.generateModule(mod.getId()).on(dir)  //
    ...
    {
        Idegen2Task.generateProject(helper.getId(), helper.getProjectDirectory()).on(dir)  //
