...
<xsl:template name="JS-escape">
    ...
    <xsl:variable name="tmp1">
        ...
        <xsl:call-template name="string-replace-all">
            ...
            <xsl:with-param name="replace" select="$t1"/>
            <xsl:with-param name="by" select="$t2"/>
        </xsl:call-template>
    </xsl:variable>
    ...
    <xsl:variable name="tmp2">
        <xsl:call-template name="string-replace-all">
            ...
            <xsl:with-param name="replace" select="$t3"/>
            <xsl:with-param name="by" select="$t4"/>
        </xsl:call-template>
    </xsl:variable>
...
<xsl:template name="br-replace">
    ...
    <xsl:variable name="t2">&lt;br/></xsl:variable>
